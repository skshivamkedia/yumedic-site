	...
	return (
		<div>
			...
			<p>
				...
				refer to YuMedic and the terms “Visitor” ”User” refer to the users
			</p>
			...
			<p>
				...
				their use of yumedic.com or their breach of the terms
			</p>
			<p>
				<b>LIABILITY</b>
				<br />
				...
				negligent or intentional, inadvertent or advertent. User agrees that
				Company shall not be responsible or liable to user, or anyone, for the
				statements or conduct of any third party of the service. In sum, in no
				event shall Company’s total liability to the User for all damages or/and
				losses or/and causes of action exceed the amount paid by the User to
			...
			<p>
				...
				were advised of the possibility of such damages. YuMedic is an
				appointment scheduling platform & we just connect doctors and patients.
				<br />
				<b>
					YuMedic IS NOT RESPONSIBLE FOR THE FUTURE PROCESSES BETWEEN DOCTORS &
					PATIENTS.
					<br /> We just deal with the appointment scheduling and nothing more
				</b>
			</p>
